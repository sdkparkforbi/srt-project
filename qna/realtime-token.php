...
- 핵심 발견: 국내 은행 기업 평균위험가중치가 36~51%로 흔히 가정하는 75%의 절반 수준이었어요. 자본경감의 크기는 우선손실 트렌치를 얼마나 두껍게 잡느냐와 얼마나 이전하느냐가 좌우해요.
- 데이터: 12개 은행 중 11개(KB·신한·하나·우리·IBK·NH·KDB·수협·부산·경남·광주)를 2025년 4분기 공시에서 실측, 제주는 표준방법이라 내부등급법 데이터가 없어요.
