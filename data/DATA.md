...
- ※ 추정 2개(경남·광주)의 기업 RWA는 2025년말 상세표가 PDF에서 추출되지 않아 **2026년 1분기 통일공시** 기준을 임시 사용(표에 † 표시, 평균RW 42% 적용). 부산은 30쪽 근방 CR6 표에서 평균RW 48.5%로 2025년말 실측 전환 완료.

## 분류
- **실측(9개)**: KB국민·신한·하나·우리·IBK기업·NH농협·KDB산업·수협·부산 — 공시 직접 추출. (CR6 합계 RWA가 「실제 위험가중자산」 표와 교차일치하여 검증됨)
- **추정(2개)**: 경남·광주 — 기본내부등급법 승인 은행이나 CR6 표의 EAD가 PDF 텍스트로 추출되지 않아 평균위험가중치 42%(실측 평균) 적용. 페이지 위치 확인 시 실측 전환 가능.
- **표준법(1개)**: 제주 — 내부등급법 미적용.
